...
let backGradient = document.getElementById("gradient")
...
function playPause() {
  ...
  if (audioElement.paused || audioElement.ended) {
    ...
    playButton.style.backgroundColor = "#5dbe96";
    playButton.style.scale = 1.7
    heroImage.style.opacity = 1; /* make album art appear when played */
    heroImage.style.scale = 1;
  } else {
    ...
    playButton.style.scale = 2;
    heroImage.style.opacity = 0.5; /* make album art disappear when paused */
    heroImage.style.scale = 0.9;
    backGradient.style.scale = 10;
  }
}
isLooping = false;


/* this toggles the looping of the music */
function toggleLoop() {
  if (isLooping) {
    audioElement.loop = false;
    isLooping = false;
    loopButton.style.scale = 2;
    loopButton.style.backgroundColor = "white";
    console.log("loopingOFF")
  } else {
    audioElement.loop = true;
    isLooping = true
    loopButton.style.scale = 1.7
    loopButton.style.backgroundColor = "#5dbe96";
    console.log("loopingON")
  }
}
